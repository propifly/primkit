...
//
//	-ldflags "-X github.com/propifly/primkit/knowledgeprim/internal/cli.Version=v0.4.1"
//
...
func newVersionCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the knowledgeprim version",
		// Override parent's PersistentPreRunE — no database needed.
		PersistentPreRunE: func(cmd *cobra.Command, args []string) error { return nil },
		Run: func(cmd *cobra.Command, args []string) {
			cmd.Println("knowledgeprim " + resolveVersion())
		},
	}
}
